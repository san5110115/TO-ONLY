  ...
  },
  {
    ...
    data: {
      questions: [
        ...
        { q: '你们认识多久了？', options: ['六个月', '152天', '192天', '更久'], answer: 2 },
...
function showGallery() {
  ...
  photosData.forEach((photo, index) => {
    ...
    img.onerror = function () {
      this.onerror = null;
      this.src = createPlaceholderSrc(photo.caption || photo.src);
    };
...
function setupGalleryFeatures() {
  ...
  function applyLayout(layout) {
    ...
    layout.forEach(item => {
      ...
      img.onerror = function () {
        this.onerror = null;
        this.src = createPlaceholderSrc(item.caption || item.src);
      };
...
function showGallery() {
  ...
  photosData.forEach((photo, index) => {
    ...
    img.onerror = function () {
      this.onerror = null;
      this.src = `https://via.placeholder.com/400x300?text=${photo.src}`;
    };
...
function setupGalleryFeatures() {
  ...
  function applyLayout(layout) {
    ...
    layout.forEach(item => {
      ...
      img.onerror = function () {
        this.onerror = null;
        this.src = `https://via.placeholder.com/400x300?text=${item.src}`;
      };
